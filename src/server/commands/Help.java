...
public class Help extends Command implements CommandUsingCommandArray{
    ...
    public Help(){
        this.description = "help : вывести справку по доступным командам";
    }
    @Override
    public CommandOutput execute() {
        ArrayList<String> response = new ArrayList<>();
        for (Object command : commandArray.values())
        {
            try {
                Command command1 = (Command) ((Class) command).getConstructor().newInstance();
                response.add(command1.getDescription());
