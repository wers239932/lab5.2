...
public class ExecuteScript extends Command implements CommandUsingLine, CommandUsingStorage, CommandUsingCommandExecuter, CommandUsingTerminal{
    ...
    {
        this.description = "execute_script file_name : считать и исполнить скрипт из указанного файла. В скрипте содержатся команды в таком же виде, в котором их вводит пользователь в интерактивном режиме.";
    }
    @Override
    ...
    public CommandOutput execute() {
        ...
        else
        {
            ...
            response.add("cannot execute script from itself");
