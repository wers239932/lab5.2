...
public class ClientCommandExecuter_Useless {
    private Boolean isRunning;
    private CommandCreator commandCreator;
    private Client client;
    private Terminal terminal;
    private LineReader lineReader;
    public ClientCommandExecuter_Useless(CommandCreator commandCreator, Client client, Terminal terminal, LineReader lineReader)
    {
